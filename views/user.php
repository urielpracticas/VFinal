...
<div class="col-xs-12">
    ...
    <br>
      ...
      <i class="fa fa-plus"></i>
       ...
       <a class="btn btn-warning" href="../includes/_sesion/cerrarSesion.php">Log Out <i
      ...
      <caption>Tabla de usuarios registrados en el sistema</caption> <!-- Descripción de la tabla -->
                         <thead>    
                         <tr>
                        <th>Nombre</th>
                        <th>Correo</th>
